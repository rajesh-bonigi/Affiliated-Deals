...
const Header = () => {
  ...
  return (
    <header className="bg-white shadow-sm sticky top-0 z-50">
      ...
      {/* Main Header */}
      <div className=" w-[82%] mx-auto px-4 sm:px-8 lg:px-1">
        <div className="flex items-center justify-between h-16">
          {/* Logo */}
          <div className="flex  items-left justify-between ">
            <h1 className="text-3xl font-bold text-red-600">DealsHub</h1> 
          ...
          <nav className="hidden md:flex item-center space-x-8">
            ...
            {/* Search Bar positioned right after Sports */}
          ...
          {/* Actions */}
            ...
            <button 
              ...
              aria-label="WhatsApp"
              onClick={() => window.open('https://wa.me/your-phone-number', '_blank')}
            >
            ...
            <button 
              ...
              onClick={() => window.open('https://instagram.com/your-instagram-handle', '_blank')}
            >
            ...
            <nav className="flex flex-col space-y-3">
              {navigation.map(item => (
                <a 
                  key={item.name} 
                  href={item.href} 
                  className="md:hidden text-gray-900 hover:text-red-600 font-medium px-2 py-1 text-sm uppercase tracking-wide"
